...
#define FOREACH_PERSONAL_CONFIG_PROPERTY(OP)						\
	...
	OP( UserConfig, VeyonMaster::userConfig(), int, videoResX, setVideoResX, "VideoResX", "Uniovi.Reflection", 1024, Configuration::Property::Flag::Standard )	\
	OP( UserConfig, VeyonMaster::userConfig(), int, videoResY, setVideoResY, "VideoResY", "Uniovi.Reflection", 768, Configuration::Property::Flag::Standard )	\
	OP( UserConfig, VeyonMaster::userConfig(), bool, saveVideo, setSaveVideo, "SaveVideo", "Uniovi.Reflection", true, Configuration::Property::Flag::Standard )	\
	OP( UserConfig, VeyonMaster::userConfig(), bool, saveScreenshots, setSaveScreenshots, "SaveScreenshots", "Uniovi.Reflection", true, Configuration::Property::Flag::Standard )	\
	OP( UserConfig, VeyonMaster::userConfig(), QString, startDateTime, setStartDateTime, "StartDateTime", "Uniovi.Reflection", QString(), Configuration::Property::Flag::Standard )	\
	OP( UserConfig, VeyonMaster::userConfig(), QString, endDateTime, setEndDateTime, "EndDateTime", "Uniovi.Reflection", QString(), Configuration::Property::Flag::Standard )	\
	OP( UserConfig, VeyonMaster::userConfig(), float, videoFrameInterval, setVideoFrameInterval, "VideoFrameInterval", "Uniovi.Reflection", 0.1f, Configuration::Property::Flag::Standard )	\
